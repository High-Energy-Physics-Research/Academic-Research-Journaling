...
\frametitle{Selected Article}
   \begin{figure}[h]
       \centering
       \includegraphics[width=0.5\textwidth]{img/selected_article.png}
       \caption{Simplifications in the likelihood and a convenient way to present the main effect of systematic uncertainties.}
