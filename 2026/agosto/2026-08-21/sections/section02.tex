...
\frametitle{Atlas ins1759506 studies}
   \begin{figure}[h]
       \centering
       \includegraphics[width=0.9\textwidth]{img/comparisson-gpfit-corr.png}
...
\frametitle{Atlas ins1759506 studies}
   \begin{figure}[h]
       \centering
       \includegraphics[width=0.9\textwidth]{img/comparisson-gpfit-uncorr.png}
       \caption{GP fit: correlation inference study}
...
\frametitle{Atlas ins1759506 studies}
   \begin{figure}[h]
       \centering
       \includegraphics[width=0.9\textwidth]{img/comparisson-gpfit-several_ell.png}
       \caption{GP fit: correlation inference study}
