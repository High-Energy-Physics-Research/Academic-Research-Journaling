...
\begin{frame}
  ...
  \begin{table}
    \begin{tabular}{|p{0.58\textwidth}|c|p{0.22\textwidth}|}
      ...
      \hspace{1.2em}\textbf{Correlation Inference Study}
      & \inprogressqqq &  \\
      \hline
...
\hline
\hspace{1.2em}\small$\hookrightarrow$ Uncertainty correlation & \done & \href{https://github.com/IFUSP-Heavy-Ions/hic-bayes/releases/tag/AllDetectorsAuAu200_uncertainty_correlation-v0.1}{Plots}\\
\hline
