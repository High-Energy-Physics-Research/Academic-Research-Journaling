...
\begin{frame}{Results}
\frametitle{Au-Au 200 JETSCAPE study}
   \begin{figure}[h]
       \centering
       \includegraphics[width=0.5\textwidth]{img/corner_all_models_1.png}
       \caption{Marginals: correlation study}
...
\frametitle{Au-Au 200 JETSCAPE study}
   \begin{figure}[h]
       \centering
       \includegraphics[width=0.5\textwidth]{img/posterior_predictive_selected_9panels.png}
       \caption{Results: correlation study}
