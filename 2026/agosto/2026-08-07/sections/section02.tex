...
\frametitle{Model validation}
   \begin{figure}[h]
       \centering
       \includegraphics[width=0.5\textwidth]{img/corner_vs_jetscape_calibration_group1.png}
       \caption{Model validation: hic-bayes vs JETSCAPE emulator}
...
\frametitle{Model validation}
   \begin{figure}[h]
       \centering
       \includegraphics[width=0.5\textwidth]{img/corner_vs_jetscape_calibration_group2.png}
       \caption{Model validation: hic-bayes vs JETSCAPE emulator}
       \label{fig:selected_article}
   \end{figure}
\end{frame}
...
\frametitle{Model validation}
   \begin{figure}[h]
       \centering
       \includegraphics[width=0.5\textwidth]{img/corner_vs_jetscape_calibration_group3.png}
       \caption{Model validation: hic-bayes vs JETSCAPE emulator}
       \label{fig:selected_article}
   \end{figure}
\end{frame}
