...
\multirow{4}{*}{\centering \href{https://high-energy-physics-research.github.io/Gaussian-Process-Research/studies.html?nb=Estudo\%2FFase+01+-+Prova+de+Conceito\%2F0.ipynb}
     {Notebook}} \\
\cline{1-2}
...
\begin{frame}
  ...
  \begin{table}
    \begin{tabular}{|p{0.58\textwidth}|c|p{0.22\textwidth}|}
      ...
      \hspace{1.2em}\small$\hookrightarrow$ Sensibilidade à escolha do kernel
      & \pending &  \\
      \hline

      \hspace{1.2em}\small$\hookrightarrow$ Otimização do log marginal
      & \pending &  \\
      \hline
      ...
      \hspace{1.2em}\small$\hookrightarrow$ Comparação: modelo correto vs kernel errado
      & \pending &  \\
      \hline
