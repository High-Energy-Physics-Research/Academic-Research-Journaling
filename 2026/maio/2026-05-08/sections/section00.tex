...
\hspace{1.2em}\small$\hookrightarrow$ Check uncertainty prediction in Atlas experiment ins1759506 & \pending & \\
\cline{1-2}
\hspace{1.2em}\small$\hookrightarrow$ Check effect on pt scaled spectra (Thiago's work) & \pending & \\
\cline{1-2}
\hline
\end{tabular}
\end{table}
