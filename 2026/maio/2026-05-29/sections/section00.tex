...
\begin{frame}
  ...
  \begin{table}
    \begin{tabular}{|p{0.58\textwidth}|c|p{0.22\textwidth}|}
      ...
      & \inprogressq  & \href{https://www.overleaf.com/project/69fcf33ccbe729b0fca5157b}{Link} \\
      \hline
...
\cline{1-2}
\hspace{1.2em}\small$\hookrightarrow$ Scaled Spectra & \inprogress & \\
\cline{1-2}
\hline
\end{tabular}
\end{table}
...
\cline{1-2}
\hspace{1.2em}\small$\hookrightarrow$ Implement effects from correlated uncertainty in scaled spectra & \inprogressqq & \href{https://high-energy-physics-research.github.io/Gaussian-Process-Research/studies.html?nb=Estudo\%2FFase+01+-+Prova+de+Conceito\%2FModel-to-data-Comparison.ipynb}
     {Notebook}\\
\cline{1-2}
\hspace{1.2em}\small$\hookrightarrow$ Analyse effects from correlated uncertainty in scaled spectra & \inprogressqq & \\
\cline{1-2}
\hline
\end{tabular}
\end{table}
...
\hspace{1.2em}\small$\hookrightarrow$ Model GP uncertainty prediction and compare with Atlas experiment ins1759506 & \inprogressqq & \href{https://high-energy-physics-research.github.io/Gaussian-Process-Research/studies.html?nb=Estudo\%2FFase+01+-+Prova+de+Conceito\%2FModel-to-data-Comparison.ipynb}
     {Notebook}\\
\cline{1-2}
\hspace{1.2em}\small$\hookrightarrow$ Check effect on Pt Scaled Spectra (Thiago's work) & \inprogressqq & \\
\cline{1-2}
\hline
\end{tabular}
\end{table}
