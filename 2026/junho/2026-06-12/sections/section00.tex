...
\cline{1-2}
\hspace{1.2em}\small$\hookrightarrow$ Uncertainty correlation & \inprogressqqq & \href{https://github.com/IFUSP-Heavy-Ions/hic-bayes/releases/tag/AtlasPbPb2760_uncertainty_correlation-v0.1}{Plots} \\
\cline{1-2}
\textbf{Atlas ins1222333 Studies} & & \\
\cline{1-2}
\hspace{1.2em}\small$\hookrightarrow$ Uncertainty correlation & \inprogressqqqqq & \\
\cline{1-2}
\textbf{RHIC Au-Au/d-Au Studies} & & \\
\cline{1-2}
