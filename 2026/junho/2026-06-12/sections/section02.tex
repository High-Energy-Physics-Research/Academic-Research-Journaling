...
\begin{frame}{Results}
\frametitle{Mcmc params study}
   \begin{figure}[h]
       \centering
       \includegraphics[width=0.7\textwidth]{img/corner_scan01_vs_scan07_production_2.png}
       \caption{}
...
\begin{frame}{Results}
\frametitle{Uncertainty correlation study}
   \begin{figure}[h]
       \centering
       \includegraphics[width=0.7\textwidth]{img/corner_rho_0.9_Grad_2_vs_baseline_Grad_2_run_002_1.png}
       \caption{}
       \label{fig:selected_article}
   \end{figure}
\end{frame}
