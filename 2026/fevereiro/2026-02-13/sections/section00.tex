...
\hspace{1.2em}\small$\hookrightarrow$ Resíduos & \done & \\
\cline{1-2}

\hspace{1.2em}\small$\hookrightarrow$ Estudo das incertezas correlacionadas e não correlacionadas, experimentais e preditas & \inprogress & \\
\cline{1-2}
...
\hspace{1.2em}\small$\hookrightarrow$ Listar método/dados (GP, Inferencia Bayesiana) & \inprogress & \\
\cline{1-2}
